...
class HomePresenter:
    ...
    def _current_batch_clicked(self) -> None:
        ...
        self.current_batch_flyout.set_content(
            "显示本月的批次数据,以及每一个批次一共有多少商品"
        )
        current_batch_table_handler = TableHandler(self.current_batch_flyout.table)
        current_batch_table_handler.set_show_headers(
            ["批次序号", "创建时间", "商品数量"]
        )
        current_batch_table_handler.set_headers(BatchCardDict)
        current_batch_table_handler.set_data(
            self.get_model().get_current_batch_card_data()
        )
    ...
    def _current_wave_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_current_wave_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _current_item_quantity_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_current_item_quantity_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _all_item_quantity_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_all_item_quantity_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _current_money_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_current_money_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _current_storage_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_current_storage_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _all_storage_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_all_storage_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _current_retrieval_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_current_retrieval_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _all_retrieval_clicked(self) -> None:
        ...
        current_batch_table_handler.set_data(
            self.get_model().get_all_retrieval_card_data()
        )
        self.current_batch_flyout.show_flyout()
    ...
    def _flush_all_label(self) -> None:
        ...
        ui.get_current_item_quantity_label().setText(
            str(self.get_model().get_current_item_quantity())
        )
        ui.get_current_money_label().setText(str(self.get_model().get_current_money()))
        ui.get_current_storage_label().setText(
            str(self.get_model().get_current_storage())
        )
        ui.get_current_retrieval_label().setText(
            str(self.get_model().get_current_retrieval())
        )
        ...
        ui.get_all_item_quantity_label().setText(
            str(self.get_model().get_all_item_quantity())
        )
    ...
    def _connect_signal(self):
        ...
        ui.get_current_item_quantity_card().clicked.connect(
            self._current_item_quantity_clicked
        )
