...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(
            ":/icons/images/icons/database_export.svg", QSize(), QIcon.Normal, QIcon.Off
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.HorizontalSeparator.sizePolicy().hasHeightForWidth()
        )
        ...
        self.TransparentPushButton = TransparentPushButton(
            self.scrollAreaWidgetContents
        )
        ...
        self.TransparentPushButton_3 = TransparentPushButton(
            self.scrollAreaWidgetContents
        )
        self.TransparentPushButton_3.setObjectName("TransparentPushButton_3")
        icon3 = QIcon()
        icon3.addFile(
    ...
    def retranslateUi(self, Form):
        ...
        self.LargeTitleLabel.setText(
            QCoreApplication.translate("Form", "\u5165\u5e93", None)
        )
        self.BodyLabel_7.setText(
            QCoreApplication.translate(
                "Form",
                "\u5c06\u5546\u54c1\u5199\u5165\u6570\u636e\u5e93,\u751f\u6210excel\u540e\u4f7f\u7528\u6253\u5370\u673a\u6253\u5370",
                None,
            )
        )
        self.SubtitleLabel_2.setText(
            QCoreApplication.translate("Form", "\u6700\u65b0\u6279\u6b21\uff1a", None)
        )
        self.SubtitleLabel.setText(
            QCoreApplication.translate("Form", "\u5165\u5e93\u4fe1\u606f", None)
        )
        ...
        self.BodyLabel_8.setText(
            QCoreApplication.translate("Form", "\u9000\u8d27\u6a21\u5f0f", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        self.BodyLabel.setText(
            QCoreApplication.translate("Form", "\u5546\u54c1\u540d\u79f0", None)
        )
        self.BodyLabel_6.setText(
            QCoreApplication.translate("Form", "\u81ea\u52a8\u6279\u6b21", None)
        )
        # if QT_CONFIG(tooltip)
        self.SwitchButton_2.setToolTip(
            QCoreApplication.translate(
                "Form",
                "\u4f7f\u7528\u8be5\u9009\u9879\u4f1a\u8fdb\u5165\u7279\u6b8a\u7684\u9000\u8d27\u6a21\u5f0f",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.SwitchButton_2.setOnText(
            QCoreApplication.translate("Form", "\u5f00\u542f", None)
        )
        self.SwitchButton_2.setOffText(
        ...
        self.PushButton.setToolTip(
            QCoreApplication.translate(
                "Form",
                "\u70b9\u51fb\u6b64\u5904\u8fdb\u884c\u9000\u8d27,\u60a8\u4e5f\u53ef\u4ee5\u5728\u4e0a\u65b9\u56de\u8f66\u6216\u8005\u4f7f\u7528\u626b\u7801\u67aa",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.PushButton.setText(
            QCoreApplication.translate("Form", "\u786e\u8ba4\u9000\u8d27", None)
        )
        self.BodyLabel_4.setText(
            QCoreApplication.translate("Form", "\u5546\u54c1\u6570\u91cf", None)
        )
        # if QT_CONFIG(tooltip)
        self.SwitchButton.setToolTip(
            QCoreApplication.translate(
                "Form",
                "<html><head/><body><p>\u5f00\u542f\u540e\u4f1a\u4ece\u6570\u636e\u5e93\u4e2d\u5bfb\u627e\u76ee\u524d\u6700\u65b0\u7684\u6279\u6b21,\u5982\u679c\u6700\u65b0\u6279\u6b21\u662f\u4eca\u5929\u4ea7\u751f\u7684</p><p>\u5219\u4f1a\u6cbf\u7528\u8be5\u6279\u6b21,\u5426\u5219\u521b\u5efa\u65b0\u7684\u6279\u6b21</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.CompactDoubleSpinBox.setToolTip(
            QCoreApplication.translate(
                "Form",
                "\u652f\u6301\u5c0f\u6570\u70b9\u540e\u4e24\u4f4d,\u6700\u591a\u652f\u6301\u5355\u4ef7\u4e3a\u5341\u4e07",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.CompactDoubleSpinBox.setSuffix(
            QCoreApplication.translate("Form", "\u5143", None)
        )
        # if QT_CONFIG(tooltip)
        self.CompactSpinBox.setToolTip(
            QCoreApplication.translate(
                "Form",
                "\u8fdb\u8d27\u6279\u6b21,\u53ef\u4ee5\u586b\u5199\u5f53\u6708\u7684\u8fc7\u5f80\u6279\u6b21,\u4f46\u662f\u4e0d\u5141\u8bb8\u6279\u6b21\u6570\u8d85\u8fc7\u6700\u65b0\u6279\u6b21\u6570+1",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.CompactSpinBox.setSuffix(
            QCoreApplication.translate("Form", "\u6279", None)
        )
        self.CompactSpinBox.setPrefix(
            QCoreApplication.translate("Form", "\u7b2c", None)
        )
        # if QT_CONFIG(tooltip)
        self.CompactSpinBox_2.setToolTip(
            QCoreApplication.translate(
                "Form",
                "\u540c\u6837\u7684\u5546\u54c1\u7684\u6570\u91cf,\u6ce8\u610f\u8be5\u6570\u91cf\u4e0d\u8981\u8d85\u8fc7\u6253\u5370\u673a\u7684\u6253\u5370\u7eb8\u6570\u91cf",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.CompactSpinBox_2.setSuffix(
            QCoreApplication.translate("Form", "\u4ef6", None)
        )
        ...
        # if QT_CONFIG(tooltip)
        self.TransparentPushButton_3.setToolTip(
            QCoreApplication.translate(
                "Form",
                "\u6570\u636e\u4f1a\u5148\u6253\u5370\u518d\u5165\u5e93,\u786e\u4fdd\u6253\u5370\u673a\u5185\u6709\u5145\u8db3\u6253\u5370\u7eb8",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.TransparentPushButton_3.setText(
            QCoreApplication.translate("Form", "\u5165\u5e93", None)
        )
        ...
        ___qtablewidgetitem5.setText(QCoreApplication.translate("Form", "2", None))
        __sortingEnabled = self.TableWidget_2.isSortingEnabled()
        self.TableWidget_2.setSortingEnabled(False)
        ___qtablewidgetitem6 = self.TableWidget_2.item(0, 0)
        ___qtablewidgetitem6.setText(
            QCoreApplication.translate("Form", "Nike\u8fd0\u52a8\u978b", None)
        )
        ___qtablewidgetitem7 = self.TableWidget_2.item(0, 1)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("Form", "NIKE", None))
        ___qtablewidgetitem8 = self.TableWidget_2.item(0, 2)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("Form", "367", None))
        ___qtablewidgetitem9 = self.TableWidget_2.item(0, 3)
        ___qtablewidgetitem9.setText(
            QCoreApplication.translate("Form", "202401001", None)
        )
        ...
        ___qtablewidgetitem11.setText(QCoreApplication.translate("Form", "NIKE", None))
        ___qtablewidgetitem12 = self.TableWidget_2.item(1, 2)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("Form", "246", None))
        ___qtablewidgetitem13 = self.TableWidget_2.item(1, 3)
        ___qtablewidgetitem13.setText(
            QCoreApplication.translate("Form", "202401002", None)
        )
