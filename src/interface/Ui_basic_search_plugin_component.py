...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Form", "\u7b5b\u9009", None))
        self.BodyLabel_3.setText(
            QCoreApplication.translate("Form", "\u6839\u636eEAN13\u67e5\u627e:", None)
        )
        ...
        self.LineEdit_5.setToolTip(
            QCoreApplication.translate(
                "Form",
                "<html><head/><body><p>\u6a21\u7cca\u641c\u7d22\u4e0d\u662f\u76f8\u4f3c\u63a8\u8350</p><p>\u641c\u7d22&quot;\u96f6\u98df&quot;\u53ea\u4f1a\u540c\u65f6\u641c\u7d22\u51fa&quot;\u597d\u96f6\u98df&quot;,&quot;\u96f6\u98df\u5999&quot;,\u800c\u65e0\u6cd5\u641c\u7d22\u51fa&quot;\u96f6\u5c0f\u98df&quot;\u6216\u8005&quot;\u85af\u7247&quot;</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.LineEdit.setToolTip(
            QCoreApplication.translate(
                "Form",
                "<html><head/><body><p>\u6ce8\u610f\u54c1\u724c\u7684\u5927\u5c0f\u5199,\u76f8\u540c\u82f1\u6587\u4f46\u662f\u5927\u5c0f\u5199\u4e0d\u540c\u7684\u54c1\u724c\u4f1a\u88ab\u8ba4\u4e3a\u662f\u4e24\u4e2a\u54c1\u724c</p><p>\u6bd4\u5982Nike\u548cnike\u5c06\u4f1a\u88ab\u8ba4\u4e3a\u662f\u4e24\u4e2a\u724c\u5b50</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.ComboBox.setText(QCoreApplication.translate("Form", "\u7b49\u4e8e", None))
        # if QT_CONFIG(tooltip)
        self.DoubleSpinBox.setToolTip(
            QCoreApplication.translate(
                "Form", "\u4ef7\u683c\u6700\u5927\u652f\u630110\u4e07\u5143", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.DoubleSpinBox.setSuffix(QCoreApplication.translate("Form", "\u5143", None))
        # if QT_CONFIG(tooltip)
        self.SwitchButton.setToolTip(
            QCoreApplication.translate(
                "Form",
                "<html><head/><body><p>\u5f00\u542f\u8be5\u9009\u9879\u624d\u80fd\u8fdb\u884c\u4ef7\u683c\u67e5\u627e</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.SwitchButton.setOnText(
            QCoreApplication.translate("Form", "\u542f\u7528", None)
        )
        self.SwitchButton.setOffText(
            QCoreApplication.translate("Form", "\u7981\u7528", None)
        )
        ...
        self.LineEdit_2.setToolTip(
            QCoreApplication.translate(
                "Form",
                "<html><head/><body><p>\u7f16\u53f7\u4e3a\u7eaf\u6570\u5b57,\u7f16\u53f7\u683c\u5f0f\u5982\u4e0b202401001</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.LineEdit_2.setPlaceholderText(
            QCoreApplication.translate("Form", "\u6279\u6b21\u7684\u7f16\u53f7", None)
        )
        ...
        self.LineEdit_4.setToolTip(
            QCoreApplication.translate(
                "Form",
                "\u7f16\u53f7\u4e3a\u7eaf\u6570\u5b57,\u7f16\u53f7\u683c\u5f0f\u5982\u4e0b202401001",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.LineEdit_4.setPlaceholderText(
            QCoreApplication.translate("Form", "\u6ce2\u6b21\u7684\u7f16\u53f7", None)
        )
        ...
        self.ComboBox_2.setText(
            QCoreApplication.translate("Form", "\u7b49\u4e8e", None)
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.SpinBox.setSuffix(QCoreApplication.translate("Form", "\u5929", None))
        # if QT_CONFIG(tooltip)
        ...
        self.PushButton.setText(
            QCoreApplication.translate("Form", "\u91cd\u7f6e\u7b5b\u9009\u9879", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("Form", "\u66f4\u591a\u9009\u9879", None)
        )
        # if QT_CONFIG(tooltip)
