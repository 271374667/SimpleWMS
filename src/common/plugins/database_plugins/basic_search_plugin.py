...
from src.view.component_view.basic_search_plugin_component_view import BasicSearchPluginComponentView
...
class BasicSearchPlugin(DatabasePluginBase):
    ...
    def get_data(self) -> list[BasicSearchDict]:
        ...
        storage_days_enable = self.custom_widget.get_storage_days_enable_sb().isChecked()
        storage_days = self.custom_widget.get_storage_days_sb().value()
        storage_days_operation = self.custom_widget.get_storage_days_operation_cb().currentIndex()
        ...
        hide_has_return_item = self.custom_widget.get_hide_had_returns_item_cb().isChecked()
